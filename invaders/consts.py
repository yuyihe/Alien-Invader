...
s = 1 #1 means user type s
left = 2 #2 means user presses left key
right = 3 #3 means user presses right key
nothing = 0 #0 means user does not press anything
LINEWIDTH = 1.1 #The thickness of the defense line
ALIEN_FASTER = 0.5 #velocity of alien gets faster by factor of 0.5 every wave
